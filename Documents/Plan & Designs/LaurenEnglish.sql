...
ALTER TABLE "attendance_record" ADD FOREIGN KEY ("period_id") REFERENCES "class_periods" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;
...
ALTER TABLE "comments" ADD FOREIGN KEY ("post_id") REFERENCES "posts" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "comments" ADD FOREIGN KEY ("author_id") REFERENCES "users" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "comments" ADD FOREIGN KEY ("parent_comment_id") REFERENCES "comments" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "folder_questions" ADD FOREIGN KEY ("folder_id") REFERENCES "question_folders" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "folder_questions" ADD FOREIGN KEY ("question_id") REFERENCES "questions" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "tests" ADD FOREIGN KEY ("classroom_id") REFERENCES "classrooms" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "test_questions" ADD FOREIGN KEY ("question_id") REFERENCES "questions" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "test_questions" ADD FOREIGN KEY ("test_id") REFERENCES "tests" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "test_question_snapshots" ADD FOREIGN KEY ("test_id") REFERENCES "tests" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "test_attempts" ADD FOREIGN KEY ("test_id") REFERENCES "tests" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "test_attempts" ADD FOREIGN KEY ("student_id") REFERENCES "users" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "submission_record" ADD FOREIGN KEY ("attempt_id") REFERENCES "test_attempts" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "submission_record" ADD FOREIGN KEY ("question_id") REFERENCES "test_question_snapshots" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;
...
ALTER TABLE "deck_words" ADD FOREIGN KEY ("deck_id") REFERENCES "flash_card_decks" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;

ALTER TABLE "deck_words" ADD FOREIGN KEY ("saved_word_id") REFERENCES "saved_words" ("id") DEFERRABLE INITIALLY IMMEDIATE ON DELETE CASCADE;
